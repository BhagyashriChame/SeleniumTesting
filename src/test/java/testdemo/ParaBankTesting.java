...
//		driver.findElement(By.id("FirstName")).sendKeys("Shri");//approch no.1, it given instance result
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.name("customer.username"))).sendKeys("Shri02");
		wait.until(ExpectedConditions.elementToBeClickable(By.name("customer.password"))).sendKeys("Admin12");
		wait.until(ExpectedConditions.elementToBeClickable(By.name("repeatedPassword"))).sendKeys("Admin12");
	...
	public void Login(){
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.name("username"))).sendKeys("Shri02");
